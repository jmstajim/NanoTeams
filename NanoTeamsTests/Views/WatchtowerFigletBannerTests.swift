...
// MARK: - Deterministic RNG for randomized tests

/// SplitMix64 — a tiny seedable `RandomNumberGenerator` so randomized helpers
/// are reproducible in tests (Swift ships no seedable RNG). Production uses
